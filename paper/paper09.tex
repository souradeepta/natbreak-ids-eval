...
\begin{table}[!t]
  \centering
  \caption{Classifier Accuracy: Baseline vs.\ NAT-Degraded vs.\ NAT-Invariant}
  \label{tab:accuracy}
  \begin{tabular}{lccc}
    \toprule
    Classifier & Baseline & Under NAT & NAT-Invariant \\
    \midrule
    Random Forest      & \BaselineAccRF{}           & \NatAccRF{}           & \NatAccRFNATInvariant{} \\
    LSTM               & \BaselineAccLSTM{}          & \NatAccLSTM{}         & --- \\
    XGBoost            & \BaselineAccXGBoost{}       & \NatAccXGBoost{}      & --- \\
    \bottomrule
  \end{tabular}
\end{table}
...
\begin{table}[!t]
  \centering
  \caption{NAT Ratio Sensitivity: RF Accuracy vs.\ NAT Scale}
  \label{tab:sensitivity}
  \begin{tabular}{lccc}
    \toprule
    NAT Ratio & Standard RF & NAT-Invariant RF \\
    \midrule
    $10$:$1$     & \RfAccAtRatioTen{}     & --- \\
    $100$:$1$    & \RfAccAtRatioHundred{} & --- \\
    $1000$:$1$   & \RfAccAtRatioThousand{} & \InvAccAtRatioThousand{} \\
    $\NatRatioLarge{}$:$1$ (SIFI) & \StdRfAccAtSifi{} & \InvRfAccAtSifi{} \\
    \bottomrule
  \end{tabular}
\end{table}
